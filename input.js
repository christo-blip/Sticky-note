...
function createNote(){
   var noteText = document.getElementById("note-text").value;
    ...
    node1.setAttribute("style","width:400px; height: 600px; font-size:24px; padding:25px; margin-top: 10px; overflow:hidden; box-shadow: 0px 10px 24px 0px rgba(0,0,0,0.75)");
